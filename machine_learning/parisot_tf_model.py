...
class GCN(Model):
    def __init__(self, placeholders, input_dim, learning_rate, weight_decay, hidden1, **kwargs):
...
class Deep_GCN(GCN):
    ...
    def __init__(self, placeholders, input_dim, depth, learning_rate, weight_decay, hidden1, **kwargs):
        self.depth = depth
        self.hidden1 = hidden1
        super(Deep_GCN, self).__init__(placeholders, input_dim, learning_rate, weight_decay, hidden1, **kwargs)
